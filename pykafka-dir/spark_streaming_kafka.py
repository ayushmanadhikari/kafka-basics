...
streaming_df = streaming_df.withColumn('lattitude', split_col.__getitem__(5))
...
col_array = ['Id', 'name', 'email', 'age', 'event', 'lattitude', 'longitude', 'timestamp']
...
final_op_stream_df = df_temp.selectExpr("Id", "lattitude", "longitude", "event", "timestamp")
...
selected_streaming_df = df_temp.select("Id", "event", "lattitude", 'longitude', "timestamp")
